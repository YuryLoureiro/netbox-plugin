...
class StatusView(View):
    ...
    def get(self, request):
        ...
        if Settings.objects.filter().exists() is False:
            return redirect("/plugins/bigipnetbox/settings/")

        data = Data.status()
        return render(
            request,
            "bigipnetbox/status.html",
            {
                "dnac": data["dnac"],
        ...
        if System.RQ.status() is False:
            ...
            return HttpResponseServerError(
                template.render(
                    {
                        "error": error_msg,
                        "exception": "bigipnetbox plugin - RQ",
...
class SyncFullFailed(View):
    ...
    def get(self, request, id):
        ...
        return render(
            request,
            "bigipnetbox/sync_full_failed.html",
            {
                "data": data,
            },
        )
    ...
    def get(self, request, **kwargs):
        ...
        return render(
            ...
            "generic/confirmation_form.html",
            {
                ...
                "form": form,
                "return_url": reverse(
                    "plugins:bigipnetbox:purge_tenant", args=(kwargs["pk"],)
                ),
            },
        )
